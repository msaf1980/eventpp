#ifndef __EVENTPP_UDP_SERVER_HPP__
#define __EVENTPP_UDP_SERVER_HPP__
...
namespace udp
{
    ...
    public:
        ...
        void SetEventLoopThreadPool(const std::shared_ptr<EventLoopThreadPool> & pool) { tpool_ = pool; }

        void set_recv_buf_size(size_t v) { recv_buf_size_ = v; }
...
#endif // __EVENTPP_UDP_SERVER_HPP__
