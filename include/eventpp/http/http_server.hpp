...
namespace http
{
	 ...
	 */
        void
        setPortSSLOption(int listen_port, bool enable_ssl, const char * certificate_chain_file = "", const char * private_key_file = "");
        /* berif 设置端口默认SSL配置选项
	 * param enable_ssl 是否开启SSL支持
	 * param certificate_chain_file 证书链文件
	 * param private_key_file 私钥文件
	 */
        void setPortSSLDefaultOption(bool enable_ssl, const char * certificate_chain_file = "", const char * private_key_file = "");
#endif
