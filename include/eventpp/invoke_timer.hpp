#ifndef __EVENTPP_INVOKE_TIMER_HPP__
#define __EVENTPP_INVOKE_TIMER_HPP__

#include <memory>

#include "sys/windows_port.h"
...
public:
    ...
    void set_cancel_callback(const Functor & fn) { cancel_callback_ = fn; }
...
#endif // __EVENTPP_INVOKE_TIMER_HPP__
