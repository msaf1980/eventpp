...
public:
    ...
    explicit EventLoop(bool preciser_timer = false, Duration shutdown_timeout = Duration(10 * duration::kSecond));
    ...
    // Getter and Setter
    struct event_base * event_base() { return evbase_; }
...
private:
    ...
    void Free();
    bool InitNotifyPipeWatcher();
    void StopInLoop();
    void FlushPendingFunctors();
