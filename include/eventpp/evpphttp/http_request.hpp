#ifndef __EVENTPP_HTTP_REQUEST_HPP__
#define __EVENTPP_HTTP_REQUEST_HPP__

#include <map>

#include "../buffer.hpp"
#include "../evpphttp/http_parser.hpp"
...
private:
    ...
    static int OnHeaderComplete(http_parser *p, const char *buf, size_t len) {
        auto req = static_cast<HttpRequest *>(p->data);
        eventpp::http_parser_parse_url(req->url.data(), req->url.size(), 1, &req->u);
        return 0;
    }
...
#endif // __EVENTPP_HTTP_REQUEST_HPP__
