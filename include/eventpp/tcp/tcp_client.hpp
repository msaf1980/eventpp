#ifndef __EVENTPP_TCP_CLIENT_HPP__
#define __EVENTPP_TCP_CLIENT_HPP__
...
public:
    ...
    Duration reconnect_interval() const { return reconnect_interval_; }
    void set_reconnect_interval(Duration timeout) { reconnect_interval_ = timeout; }
    Duration connecting_timeout() const { return connecting_timeout_; }
    ...
    void set_context(const std::any & c) { context_ = c; }
...
#endif // __EVENTPP_TCP_CLIENT_HPP__
