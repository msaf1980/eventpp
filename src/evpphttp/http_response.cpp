...
#include <eventpp/evpphttp/http_response.hpp>
...
void HttpResponse::SendContinue(const eventpp::TCPConnPtr& conn) {
    Buffer buf;
...
void HttpResponse::SendReply(const eventpp::TCPConnPtr& conn, const int response_code, const std::map<std::string, std::string>& header_field_value, const std::string & response_body) {
